...
proc vTcl:project:info {} {
    ...
    namespace eval ::widgets::$base.zColumn {
        array set save {-text 1}
    }
    namespace eval ::widgets::$base.z1 {
        array set save {-background 1 -insertbackground 1 -textvariable 1}
    }
    namespace eval ::widgets::$base.z2 {
        array set save {-background 1 -insertbackground 1 -textvariable 1}
    }
    namespace eval ::widgets::$base.z3 {
        array set save {-background 1 -insertbackground 1 -textvariable 1}
    }
    namespace eval ::widgets::$base.z4 {
        array set save {-background 1 -insertbackground 1 -textvariable 1}
    }
    namespace eval ::widgets::$base.z5 {
        array set save {-background 1 -insertbackground 1 -textvariable 1}
    }
    namespace eval ::widgets::$base.z6 {
        array set save {-background 1 -insertbackground 1 -textvariable 1}
    }
...
proc vTclWindow.top47 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 613x288+258+128; update
    wm maxsize $top 1265 994
    wm minsize $top 1 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    wm deiconify $top
    wm title $top "3D Gnuplot Interface"
    ...
    button $top.but50 \
        \
        -command {puts $fileid "set view 0,0"

if { $stat == 1 } {
    puts -nonewline $fileid "splot 'map3D.dat' w d lt -1"
    for {set i 1} {$i <= 6} {incr i} {
      if {$SelectButton($i) == 1} {
         puts -nonewline $fileid ", '$fname($i)' using $x($i):$y($i):$z($i) t '$t($i)'"
      }
    }
} else {
    puts -nonewline $fileid "splot "
    set flag 0
    for {set i 1} {$i <= 6} {incr i} {
      if {$SelectButton($i) == 1} {
	 if { $flag == 0 } {
...
set command ""
    ...
    label $top.zColumn \
        -text {Z Column} 
    vTcl:DefineAlias "$top.zColumn" "Label7" vTcl:WidgetProc "Toplevel1" 1
    entry $top.z1 \
        -background white -insertbackground black -textvariable z(1) 
    vTcl:DefineAlias "$top.z1" "Entry26" vTcl:WidgetProc "Toplevel1" 1
    entry $top.z2 \
        -background white -insertbackground black -textvariable z(2) 
    vTcl:DefineAlias "$top.z2" "Entry27" vTcl:WidgetProc "Toplevel1" 1
    entry $top.z3 \
        -background white -insertbackground black -textvariable z(3) 
    vTcl:DefineAlias "$top.z3" "Entry28" vTcl:WidgetProc "Toplevel1" 1
    entry $top.z4 \
        -background white -insertbackground black -textvariable z(4) 
    vTcl:DefineAlias "$top.z4" "Entry29" vTcl:WidgetProc "Toplevel1" 1
    entry $top.z5 \
        -background white -insertbackground black -textvariable z(5) 
    vTcl:DefineAlias "$top.z5" "Entry30" vTcl:WidgetProc "Toplevel1" 1
    entry $top.z6 \
        -background white -insertbackground black -textvariable z(6) 
    vTcl:DefineAlias "$top.z6" "Entry31" vTcl:WidgetProc "Toplevel1" 1
    button $top.capture \
        \
        -command {#set filename [tk_getOpenFile]
...
puts $fileid "set term pop"} \
    ...
    ###################
    place $top.but50 \
        -in $top -x 95 -y 255 -anchor nw -bordermode ignore 
    place $top.but47 \
        -in $top -x 450 -y 255 -anchor nw -bordermode ignore 
    ...
    place $top.title \
        -in $top -x 465 -y 15 -anchor nw -bordermode ignore 
    place $top.fName1 \
    ...
    place $top.y1 \
        ...
        -bordermode ignore 
    place $top.t1 \
        -in $top -x 428 -y 40 -width 148 -height 22 -anchor nw \
        -bordermode ignore 
    place $top.fname2 \
    ...
    place $top.y2 \
        ...
        -bordermode ignore 
    place $top.t2 \
        -in $top -x 430 -y 70 -width 148 -height 22 -anchor nw \
        -bordermode ignore 
    place $top.fname3 \
    ...
    place $top.y3 \
        ...
        -bordermode ignore 
    place $top.t3 \
        -in $top -x 429 -y 100 -width 148 -height 22 -anchor nw \
        -bordermode ignore 
    place $top.fname4 \
    ...
    place $top.y4 \
        ...
        -bordermode ignore 
    place $top.t4 \
        -in $top -x 430 -y 130 -width 148 -height 22 -anchor nw \
        -bordermode ignore 
    place $top.fname5 \
    ...
    place $top.y5 \
        ...
        -bordermode ignore 
    place $top.t5 \
        -in $top -x 430 -y 160 -anchor nw -bordermode ignore 
    place $top.fname6 \
    ...
    place $top.y6 \
        ...
        -bordermode ignore 
    place $top.t6 \
        -in $top -x 430 -y 190 -anchor nw -bordermode ignore 
    place $top.cpd64 \
        -in $top -x 15 -y 215 -width 566 -height 28 -anchor nw \
        -bordermode inside 
    place $top.button1 \
    ...
    place $top.zColumn \
        -in $top -x 351 -y 15 -width 60 -height 20 -anchor nw \
        -bordermode ignore 
    place $top.z1 \
        -in $top -x 363 -y 40 -width 33 -height 22 -anchor nw \
        -bordermode ignore 
    place $top.z2 \
        -in $top -x 365 -y 70 -width 33 -height 22 -anchor nw \
        -bordermode ignore 
    place $top.z3 \
        -in $top -x 365 -y 100 -width 33 -height 22 -anchor nw \
        -bordermode ignore 
    place $top.z4 \
        -in $top -x 365 -y 130 -width 33 -height 22 -anchor nw \
        -bordermode ignore 
    place $top.z5 \
        -in $top -x 365 -y 160 -width 33 -height 22 -anchor nw \
        -bordermode ignore 
    place $top.z6 \
        -in $top -x 365 -y 190 -width 33 -height 22 -anchor nw \
        -bordermode ignore 
    place $top.capture \
        -in $top -x 257 -y 255 -width 110 -height 26 -anchor nw \
        -bordermode ignore 
